...
**WRITE** `sudo beegfs benchmark start --block-size=1MiB --size=10GiB --num-tasks=5 --watch=1s`
...
| METRIC    | THROUGHPUT  | TARGET ID | TARGET ALIAS        | ON NODE        |
+-----------+-------------+-----------+---------------------+----------------+
| Minimum   | 244.07MiB/s | s:701     | target_0-69285D69-7 | node_storage_7 |
| Maximum   | 286.02MiB/s | s:101     | target_0-69285B54-1 | node_storage_1 |
| Average   | 277.67MiB/s | -         | -                   |                |
| Aggregate |   4.34GiB/s | -         | -                   |                |
+-----------+-------------+-----------+---------------------+----------------+
```

**READ** `sudo beegfs benchmark start --block-size=1MiB --size=10GiB --num-tasks=5 --watch=1s -r`
...
| METRIC    | THROUGHPUT  | TARGET ID | TARGET ALIAS        | ON NODE        |
+-----------+-------------+-----------+---------------------+----------------+
| Minimum   | 296.55MiB/s | s:701     | target_0-69285D69-7 | node_storage_7 |
| Maximum   | 831.07MiB/s | s:301     | target_0-69285D63-3 | node_storage_3 |
| Average   | 601.99MiB/s | -         | -                   |                |
| Aggregate |   9.41GiB/s | -         | -                   |                |
+-----------+-------------+-----------+---------------------+----------------+
```
...
> [!IMPORTANT]
> BeegFS is not usable in production because of redundancy, which needs entreprise license.
